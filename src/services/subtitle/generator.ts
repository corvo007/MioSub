...
export const generateAssContent = (subtitles: SubtitleItem[], title: string, bilingual: boolean = true, includeSpeaker: boolean = false, useSpeakerColors: boolean = false): string => {
    // Updated Styles: 
    ...
    const speakerStyles = uniqueSpeakers.map(speaker => {
