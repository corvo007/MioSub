            ...
            <div className="bg-slate-900 border border-red-500/30 rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
                <div className="p-6 text-center space-y-4">
                    ...
                    <div className="flex flex-col space-y-2 pt-4">
                        ...
                        <button onClick={onContinue} disabled={isGeneratingGlossary} className="w-full bg-slate-800 hover:bg-slate-700 text-slate-300 font-medium py-2 rounded-lg transition-colors">
                            跳过 (继续而不使用新术语)
                        </button>
                    </div>
                </div>
