...
export const GlossaryManager: React.FC<GlossaryManagerProps> = ({
    ...
    const handleRename = (id: string) => {
        ...
        const updated = glossaries.map(g =>
            g.id === id ? renameGlossary(g, editNameValue) : g
        );
                    ...
                    <div className="flex-1 overflow-y-auto p-2 space-y-1 custom-scrollbar">
                        {glossaries.map(glossary => (
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    {editingNameId === glossary.id ? (
                                        ...
                                        <div className="flex items-center">
                                            <span className={`text-sm font-medium truncate ${selectedGlossaryId === glossary.id ? 'text-white' : 'text-slate-300'}`}>
                                                {glossary.name}
                                            </span>
                                ...
                                <div className={`flex items-center space-x-1 ${selectedGlossaryId === glossary.id ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} transition-opacity`}>
                                    <button
                                    ...
                                    <button
                                        onClick={(e) => { e.stopPropagation(); setShowDeleteConfirm(glossary.id); }}
                                    ...
                                    <div className="space-y-2">
                                                    ...
                                                    <input
                                                        ...
                                                        onKeyDown={(e) => {
                                                            if (e.key === 'Enter') {
                                                                ...
                                                                if (term && translation) {
                                                                    handleUpdateTerms([...selectedGlossary.terms, { term, translation, notes }]);
                                        ...
                                        {selectedGlossary.terms
                                            ...
                                            .map(({ item, originalIndex }) => (
                                                <div key={originalIndex} className={`flex items-start space-x-2 p-3 rounded-lg border transition-all ${editingTermIndex === originalIndex ? 'bg-indigo-900/20 border-indigo-500/50' : 'hover:bg-slate-800/50 border-transparent hover:border-slate-700/50 group'}`}>
                                                        ...
                                                        <>
                                                            <div className="flex-1 space-y-1">
                                                                <div className="flex flex-col space-y-0.5">
                                                                    ...
                                                                    <span className="text-indigo-400 text-sm">{item.translation}</span>
                                                                    {item.notes && (
