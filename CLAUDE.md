...
> **⚠️ MANDATORY: Before performing ANY analytics query, Sentry investigation, or issue triage, you MUST first read [docs/analytics-monitoring.md](docs/analytics-monitoring.md).**

This includes:

- Querying Sentry, Amplitude, or Mixpanel
- Investigating production errors
- Triaging or closing issues
- Adding new tracking events

The document contains platform configuration, query guidelines, and investigation workflows that are **required** for correct operation.

Quick reference (see full doc for details):

- **Sentry**: org `corvo007`, project `miosub`
- **Amplitude**: project `miosub-3.0` (appId: `781359`)
- **Mixpanel**: project `miosub` (project_id: `3985897`)
- **Events Reference**: [docs/analytics-events.md](docs/analytics-events.md) (auto-generated by `yarn docs:analytics`)
