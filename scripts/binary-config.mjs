...
export const BINARIES = {
  ...
  'bs-roformer-cli': {
    'win32-x64': {
      ...
      type: 'zip',
      extract: [{ from: 'bs-roformer-cli.exe', to: 'bs-roformer-cli.exe' }],
    },
    'linux-x64': {
      url: 'https://github.com/corvo007/BSRoformer.cpp/releases/latest/download/BSRoformer-linux-vulkan.tar.gz',
      type: 'tar.gz',
      extract: [{ from: 'bs-roformer-cli', to: 'bs-roformer-cli' }],
    },
    'linux-arm64': {
      url: 'https://github.com/corvo007/BSRoformer.cpp/releases/latest/download/BSRoformer-linux-arm64-cpu.tar.gz',
      type: 'tar.gz',
      extract: [{ from: 'bs-roformer-cli', to: 'bs-roformer-cli' }],
    },
    'darwin-x64': {
      url: 'https://github.com/corvo007/BSRoformer.cpp/releases/latest/download/BSRoformer-macos-x64.tar.gz',
      type: 'tar.gz',
      extract: [{ from: 'bs-roformer-cli', to: 'bs-roformer-cli' }],
    },
    'darwin-arm64': {
      url: 'https://github.com/corvo007/BSRoformer.cpp/releases/latest/download/BSRoformer-macos-arm64.tar.gz',
      type: 'tar.gz',
      extract: [{ from: 'bs-roformer-cli', to: 'bs-roformer-cli' }],
    },
  },
